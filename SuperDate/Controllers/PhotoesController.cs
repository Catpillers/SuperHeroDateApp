...
namespace SuperDate.Controllers
{
    ...
    public class PhotoesController : ControllerBase
    {
        ...
        public PhotoesController(IDatingRepository repo, IMapper mapper,
                                IOptions<CloudinarySettings> cloudineryConfig)
        {
            ...
            Account acc = new Account(
                cloudineryConfig.Value.CloudName,
        ...
        public async Task<IActionResult> SetMainPhoto(int userId, int id)
        {
            ...
            return BadRequest("Could not set your photo as main");
        }
        ...
        public async Task<IActionResult> DeletePhoto(int userId, int id)
        {
            ...
            if (photoFromRepo.IsMain)
            {
                return BadRequest("You canntor delete your main photo!");
            }
            ...
            return BadRequest("There was a problem in deletion of your photo!"); 
